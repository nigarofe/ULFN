...
- A unidade do momento de inércia é $\displaystyle [\mathrm{kg\cdot m^2}]$. Em termos de torque e aceleração angular, isso também pode ser visto como $\mathrm{N\cdot m/(rad/s^2)}$, pois a relação básica de rotação é $τ  =  
